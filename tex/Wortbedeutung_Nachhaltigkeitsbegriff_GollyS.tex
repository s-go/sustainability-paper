...
\urldef{\urlkollokC}\url{http://kaskade.dwds.de/dstar/public/diacollo/?query=%24l%3D%2Fnachhaltig%2Fi&date=1916%3A1985&slice=0&score=ld&kbest=0&cutoff=&profile=2&format=html&groupby=&eps=0}
%\urldef{\urlXXX}\url{}
...
%\subsubsection{Frequenzanalyse}
%
%In der Epoche von 1776 bis 1845 gibt es nur 206 Korpusbelege für \textit{nachhaltig} und verwandte Benennungen. Tabelle~\ref{tab:freq-epoche1} zeigt die Frequenzentwicklung pro Zehnjahreszeitraum, Abbildung~\ref{fig:nachhaltig-freq-1776-1845} illustriert die Frequenzverteilung.
%
%\begin{table}[h!]
%	\centering
%	\renewcommand{\arraystretch}{1.5}
